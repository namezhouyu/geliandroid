...
/**
 * Created by LB on 2017/7/3/0003.
 */
...
public class ShapeImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            borderColor = array.getColor(R.styleable.ShapeImageView_ml_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.ShapeImageView_ml_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.ShapeImageView_ml_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.ShapeImageView_ml_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.ShapeImageView_ml_radius, radius);
            shapeType = array.getInteger(R.styleable.ShapeImageView_ml_shape_type, shapeType);
            array.recycle();
        }
    ...
    private void drawDrawable(Canvas canvas, Bitmap bitmap) {
        ...
        // 标志
//        int saveFlags = Canvas.MATRIX_SAVE_FLAG //0x01
//                | Canvas.CLIP_SAVE_FLAG  //0x02
//                | Canvas.HAS_ALPHA_LAYER_SAVE_FLAG //0x04
//                | Canvas.FULL_COLOR_LAYER_SAVE_FLAG //0x08
//                | Canvas.CLIP_TO_LAYER_SAVE_FLAG; //0x10;
