...
public class PasswordInputView extends AppCompatEditText {
    ...
    private float defaultContMargin = 5;
    private float defaultSplitLineWidth = 3;

    private int borderColor = 0xFFCCCCCC;
    private int outBorderColor = 0xFFCCCCCC;
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        ...
        outBorderColor = a.getColor(R.styleable.PasswordInputView_pivOutBorderColor, borderColor);
        borderWidth = a.getDimension(R.styleable.PasswordInputView_pivBorderWidth, borderWidth);
        defaultSplitLineWidth = a.getDimension(R.styleable.PasswordInputView_pivSplitLineWidth, defaultSplitLineWidth);
