...
public class ShopLocalRestaurantVH extends BaseViewHolder<RestaurantShopBean.DataBean> {
    ...
    public ShopLocalRestaurantVH(ViewGroup parent, Context context) {
...
//        if(data.getCat_res() != null && data.getCat_res().size() > 3){
//            mAdapterKeyWord.addAll(data.getCat_res().subList(0, 3));
//        }else {
//            mAdapterKeyWord.addAll(data.getCat_res());
//        }
    ...
    private RecyclerArrayAdapter initAdapterKeyWord() {
        mAdapterKeyWord = new RecyclerArrayAdapter(mContext) {
            ...
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                return new KeyWordLocalRestaurantVH(parent, mContext);
            }
        };
    ...
    private RecyclerArrayAdapter initAdapterGoods() {
        mAdapterGoods = new RecyclerArrayAdapter(mContext) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                return new ShopGoodsLocalRestaurantVH(parent, mContext);
            }
        };
