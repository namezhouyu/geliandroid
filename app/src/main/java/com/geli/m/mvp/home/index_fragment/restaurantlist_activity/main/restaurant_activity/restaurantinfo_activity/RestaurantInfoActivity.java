 ...
 * 新批发--详情
 */
public class RestaurantInfoActivity extends MVPActivity<RestaurantInfoPresentImpl> implements RestaurantInfoView {
    ...
    @Override
    protected RestaurantInfoPresentImpl createPresenter() {
        return new RestaurantInfoPresentImpl(this);
    }
    ...
    private void initAdapter() {
        mMEAdapter = new RecyclerArrayAdapter(mContext) {
            ...
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                return new RestaurantInfoVH(parent, mContext);
            }
        };
    ...
    public void onClick(View view){
        switch (view.getId()){
            ...
            case R.id.llayout_location_RestaurantInfoActivity:      /* 地址 */
                ...
                mPopupWindow = new MyListPopupWindow(RestaurantInfoActivity.this, 0.5f) {
                    @Override
