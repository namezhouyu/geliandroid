...
public class ShopGoodsLocalRestaurantVH extends BaseViewHolder<RestaurantShopBean.DataBean.GoodsResBean> {
    ...
    public ShopGoodsLocalRestaurantVH(ViewGroup parent, Context context) {
