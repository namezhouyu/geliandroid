...
public abstract class ViewPagerLayoutManager extends LinearLayoutManager {
    ...
    protected boolean startMarger = true;
    ...
    public void setStartMaeger(boolean isStartMarger) {
        startMarger = isStartMarger;
    }
    ...
    private float getMaxOffset() {
        float offset = !mShouldReverseLayout ? (getItemCount() - 1) * mInterval : 0;
        if (!startMarger) {
            offset -= mSpaceMain;
        }
        return offset;
    ...
    private float getMinOffset() {
        float offset = !mShouldReverseLayout ? 0 : -(getItemCount() - 1) * mInterval;
        return offset;
    }
