...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param isDashed      是否画虚线
     */
    public DividerItemDecoration(Context context, int orientation, int dividerHeight, int dividerColor, boolean isDashed) {
        this(context, orientation);
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (mPaint != null) {
                if(!mIsDashed){
                    ...
                    // float数组的四个数是指的先画15px的实线，然后画10px的空白再画15px的实线，再画10px的空白...一次规律循环。
                    // 后面的“5”指的是第一条实线要距离开始位置多远。
                }
            }
        }
    }
